  ...
  (e.fn.fullpage = function(l) {
    ...
    function pe(n) {
      if (!vt.hasClass(f)) {
        ...
        o && de(o + 1),
        (mt = !1),
        e.isFunction(l.afterResize) && n && l.afterResize.call(vt),
        e.isFunction(l.afterReBuild) && !n && l.afterReBuild.call(vt);
      }
    }
    function ve(n) {
      var t = lt.hasClass(c);
      n
        ? t ||
          ...
          e(A).hide(),
          lt.addClass(c),
          e.isFunction(l.afterResponsive) && l.afterResponsive.call(vt, n))
        : t &&
          (s(Et.autoScrolling, 'internal'),
    ...
    function me() {
      ...
      te
        ...
        .on('click touchstart', N, hn)
        .on('click', O, rn),
      e(y).on('click touchstart', X, dn),
    ...
    function Se() {
      ...
      l.fixedElements && l.css3 && e(l.fixedElements).appendTo(lt),
      l.navigation && ke(),
      Le(),
      l.scrollOverflow
    ...
    function ye(n, t, o) {
      ...
      o > 1 && (l.controlArrows && Te(n), l.slidesNavigation && Pn(n, o)),
      t.each(function(n) {
    ...
    function xe(n, t) {
      ...
      l.menu &&
          ...
          e(l.menu).appendTo(lt);
    }
    function Ce() {
      vt.find(l.sectionSelector).addClass(S),
      vt.find(l.slideSelector).addClass(R);
    }
    function Te(e) {
      e
        .find(q)
    ...
    function De(n) {
      ...
      if (!Pe(n.target) && qe(t)) {
        ...
        (Bt = r.y),
        (Rt = r.x),
        i.find(q).length && o.abs(Ht - Rt) > o.abs(Ot - Bt)
          ? !ut &&
              o.abs(Ht - Rt) > (ne.outerWidth() / 100) * l.touchSensitivity &&
              (Ht > Rt ? bt.m.right && ue(i) : bt.m.left && he(i))
          : l.autoScrolling &&
              St &&
              o.abs(Ot - Bt) > (ne.height() / 100) * l.touchSensitivity &&
              (Ot > Bt ? Re('down', a) : Bt > Ot && Re('up', a));
      }
    }
    function Pe(n, t) {
      t = t || 0;
      ...
      if ('undefined' !== typeof n) {
        ...
        (s.activeSection.is(n) && !mt) ||
          ...
          (!e.isFunction(l.onLeave) ||
            ...
            (St = !1),
            qn(a, i, s.anchorLink, s.sectionIndex),
            Xe(s),
            (ct = s.anchorLink),
            In(s.anchorLink, s.sectionIndex)));
      }
    }
    function Xe(n) {
    ...
    function vn(e) {
      St &&
        (e.pageY < Pt && bt.m.up ? se() : e.pageY > Pt && bt.m.down && ce()),
      (Pt = e.pageY);
    }
    function gn(n, t, o) {
      var i = n.closest(y),
      ...
      return (
        ...
        l.onSlideLeave.call(
          ...
          : (t
            ...
            .siblings()
            .removeClass(p),
          a.localIsResizing || (en(a.prevSlide), Ze(t)),
          !l.loopHorizontal &&
              l.controlArrows &&
              (i.find(J).toggle(0 !== a.slideIndex),
              i.find(ee).toggle(!t.is(':last-child'))),
          i.hasClass(p) &&
              qn(a.slideIndex, a.slideAnchor, a.anchorLink, a.sectionIndex),
          void wn(n, a, !0))
      );
    }
    function mn(n) {
    ...
    function Wn() {
      ...
      (lt[0].className = lt[0].className.replace(r, '')),
      lt.addClass(h + '-' + a);
    }
    function Yn() {
      var e,
    ...
    function jn() {
      t.addEventListener
        ? (t.removeEventListener('mousewheel', We, !1),
        t.removeEventListener('wheel', We, !1),
        t.removeEventListener('MozMousePixelScroll', We, !1))
        : t.detachEvent('onmousewheel', We);
    }
    function Nn() {
      var e,
        o = '';
      ...
      var a =
        'onwheel' in t.createElement('div')
          ...
          : t.onmousewheel !== i
            ...
            : 'DOMMouseScroll';
      'DOMMouseScroll' === a
        ? t[e](o + 'MozMousePixelScroll', We, !1)
        : t[e](o + a, We, !1);
    }
    function Un() {
    ...
    function Kn() {
      if (l.autoScrolling && (ht || pt)) {
        var n = Gn();
        lt.off('touchmove ' + n.move).on('touchmove ' + n.move, ze),
        e(r)
          .off('touchstart ' + n.down)
          .on('touchstart ' + n.down, Fe)
    ...
    function tt() {
      ...
      lt.removeClass(c),
      e.each(lt.get(0).className.split(/\s+/), function(e, n) {
    ...
    e(this).length &&
        ((st.setAutoScrolling = s),
        (st.setRecordHistory = U),
        (st.setScrollingSpeed = Q),
        (st.setFitToSection = Z),
        (st.setLockAnchors = $),
        (st.setMouseWheelScrolling = ae),
        (st.setAllowScrolling = re),
        (st.setKeyboardScrolling = le),
        (st.moveSectionUp = se),
        (st.moveSectionDown = ce),
        (st.silentMoveTo = de),
        (st.moveTo = fe),
        (st.moveSlideRight = ue),
        (st.moveSlideLeft = he),
        (st.reBuild = pe),
        (st.setResponsive = ve),
        (st.destroy = nt),
